...
public class Game {
    ...
    public void inGameMenu () {
        ...
        while (exit == 0) {
            ...
            System.out.println("4-Press 4 to show letter/number frequency");
            System.out.println("4-Press 5 to go to the previous menu");
            try {
    ...
    public void LetterNumberFrequency() {
        ...
        currentCryptogram.cipheredArray.removeIf(s -> s.equals("-1"));
        String listString = String.join("",currentCryptogram.cipheredArray);
